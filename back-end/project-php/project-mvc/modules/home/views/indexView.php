        ...
        <div class="main-content fl-right">
            ...
            <div class="section" id="feature-product-wp">
                ...
                <div class="section-detail">
                    <ul class="list-item">
                        <li>
                            <a href="?mod=detail_product" title="" class="thumb">
                                <img src="public/images/img-pro-05.png">
                            </a>
                            <a href="?mod=detail_product" title="" class="product-name">Laptop Lenovo IdeaPad 120S</a>
                            <div class="price">
                        ...
                        <li>
                            ...
                            <a href="?mod=detail_product" title="" class="product-name">Samsung Galaxy S8 Plus</a>
                            <div class="price">
                        ...
                        <li>
                            ...
                            <a href="?mod=detail_product" title="" class="product-name">Laptop Acer Aspire ES1</a>
                            <div class="price">
                        ...
                        <li>
                            ...
                            <a href="?mod=detail_product" title="" class="product-name">Sony Xperia XZ Premium</a>
                            <div class="price">
                        ...
                        <li>
                            ...
                            <a href="?mod=detail_product" title="" class="product-name">Laptop Asus E402NA</a>
                            <div class="price">
                        ...
                        <li>
                            ...
                            <a href="?mod=detail_product" title="" class="product-name">IPhone 7 128GB</a>
                            <div class="price">
                ...
                <div class="section-detail">
                    <ul class="list-item clearfix">
                        <li>
                            ...
                            <a href="?mod=detail_product" title="" class="product-name">Motorola Moto G5S Plus</a>
                            <div class="price">
                        ...
                        <li>
                            ...
                            <a href="?mod=detail_product" title="" class="product-name">Samsung Galaxy A5</a>
                            <div class="price">
                        ...
                        <li>
                            ...
                            <a href="?mod=detail_product" title="" class="product-name">Sony Xperia XA Ultra</a>
                            <div class="price">
                        ...
                        <li>
                            ...
                            <a href="?mod=detail_product" title="" class="product-name">Huawei Nova 2i</a>
                            <div class="price">
                                <span class="new">5.990.000đ</span>
                        ...
                        <li>
                            ...
                            <a href="?mod=detail_product" title="" class="product-name">Xiaomi Mi A1</a>
                            <div class="price">
                                <span class="new">5.990.000đ</span>
                                <span class="old">6.990.000đ</span>
                            </div>
                        ...
                        <li>
                            ...
                            <a href="?mod=detail_product" title="" class="product-name">HTC U Ultra Sapphire</a>
                            <div class="price">
                        ...
                        <li>
                            ...
                            <a href="?mod=detail_product" title="" class="product-name">Sony Xperia XZ Dual</a>
                            <div class="price">
                        ...
                        <li>
                            ...
                            <a href="?mod=detail_product" title="" class="product-name">Bphone 2017</a>
                            <div class="price">
