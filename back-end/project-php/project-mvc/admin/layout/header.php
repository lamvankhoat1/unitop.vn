                    ...
                    <div class="wp-inner clearfix">
                        ...
                        <ul id="main-menu" class="fl-left">
                            <li>
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="?mod=pages&controller=add&action=add" title="">Thêm mới</a> 
                                    </li>
                                    <li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="?mod=post&controller=add&action=add" title="">Thêm mới</a> 
                                    </li>
                                    <li>
                                        <a href="?mod=post" title="">Danh sách bài viết</a> 
                                    </li>
                                    <li>
                                        <a href="?mod=post&controller=category" title="">Danh mục bài viết</a> 
                                    </li>
                                </ul>
                            </li>
                            <li>
