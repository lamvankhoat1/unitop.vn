...
<?php
  if (isset($_POST['checkout'])) {
    redirect_to("?mod=cart&act=thank");
  }

  # Lấy ra thông tin đơn hàng trong session
  # Đõ dữ liệu
                                    ...
                                    <table class="shop-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="cart-item">
                                                ...
                                                <td class="product-total"><?php echo currency($product['qty'] * $product['price']); ?></td>
                                            </tr>
                                            <?php }?>
                                        </tbody>
                                        <tfoot>
                                            <tr class="order-total">
                                                <td>Tổng đơn hàng:</td>
                                                <td><strong class="total-price"><?php echo currency($_SESSION['cart']['info']['price']); ?></strong></td>
                                            </tr>
                                        </tfoot>
                                    </table>
